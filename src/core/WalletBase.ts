...
export abstract class WalletBase {
    ...
    protected get walletInfo(): { address?: string; isConnected: boolean; publicKey: string | undefined; chainType: string; provider: any} {
        throw new Error('Not implemented');
    }
    ...
    getWallet(): { address?: string; isConnected: boolean; publicKey: string | undefined; chainType: string; provider: any} {
        // 获取钱包信息
        return {
